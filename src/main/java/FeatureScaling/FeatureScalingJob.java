...
import SignificantDay.SignificantDayMapper;
import SignificantDay.SignificantDayReducer;
import SignificantDay.SignificantJob;
...
public class FeatureScalingJob {
    public static void main(String[] args) {
        try {
            ...
            /* Current class */
            job.setJarByClass(FeatureScalingJob.class);

            /* Mapper class */
            job.setMapperClass(FeatureScalingMapper.class);
            ...
            /* Reducer class */
            job.setReducerClass(FeatureScalingReducer.class);
