...
public class ActivityHourJob {
    public static void main(String[] args) {
        try {
            ...
            /* Current class */
            job.setJarByClass(ActivityHourJob.class);

            /* Mapper class */
            job.setMapperClass(ActivityHourMapper.class);
            ...
            /* Reducer class */
            job.setReducerClass(ActivityHourReducer.class);
