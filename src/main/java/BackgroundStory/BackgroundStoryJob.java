...
public class BackgroundStoryJob {
    public static void main(String[] args) {
        try {
            ...
            /* Current class */
            job.setJarByClass(BackgroundStoryJob.class);

            /* Mapper class */
            job.setMapperClass(BackgroundStoryMapper.class);
            ...
            /* Reducer class */
            job.setReducerClass(BackgroundStoryReducer.class);

            /* Outputs from the Mapper. */
            job.setMapOutputKeyClass(Text.class);
            job.setMapOutputValueClass(UserStoryWritable.class);

            /* Outputs from the Reducer */
            job.setOutputKeyClass(Text.class);

            job.setOutputValueClass(UserStoryWritable.class);
