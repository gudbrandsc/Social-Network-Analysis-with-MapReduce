...
public class ScreamersJob {
    public static void main(String[] args) {
        try {
            ...
            /* Current class */
            job.setJarByClass(ScreamersJob.class);

            /* Mapper cla   ss */
            job.setMapperClass(ScreamersMapper.class);
            ...
            /* Reducer class */
            job.setReducerClass(ScreamersReducer.class);

            /* Outputs from the Mapper. */
            job.setMapOutputKeyClass(Text.class);
            job.setMapOutputValueClass(SubRedditWritable.class);

            /* Outputs from the Reducer */
            job.setOutputKeyClass(Text.class);

            job.setOutputValueClass(SubRedditWritable.class);
